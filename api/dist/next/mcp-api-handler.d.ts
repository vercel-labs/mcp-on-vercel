...
export declare function initializeMcpApiHandler(initializeServer: (server: McpServer) => void, serverOptions?: ServerOptions, config?: Config): (req: Request, res: ServerResponse) => Promise<void>;
